...
describe('Quantsisnetd Functionality', function() {
  ...
  before(function(done) {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      quantisnetd = require('../').services.Quantsisnet({
        spawn: {
          datadir: datadir,
      ...
      log.info('Waiting for Quantsisnet Core to initialize...');

      quantisnetd.start(function() {
        log.info('Quantsisnetd started');

        client = new QuantsisnetdRPC({
          protocol: 'http',
          host: '127.0.0.1',
          port: 30331,
          user: 'quantisnet',
