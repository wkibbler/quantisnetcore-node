...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.quantisnet', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/quantisnetcore-node.json';
      ...
      config.services.should.deep.equal(['quantisnetd', 'db', 'address', 'web']);
